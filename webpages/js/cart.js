function cartUpdate() {
    ...
    listenCartUpdate("/webpages/assets/placeholder.png", "Item 1", itemsNum[0], prices[0]);
    listenCartUpdate("/webpages/assets/placeholder.png", "Item 2", itemsNum[1], prices[1]);
    listenCartUpdate("/webpages/assets/placeholder.png", "Item 3", itemsNum[2], prices[2]);
